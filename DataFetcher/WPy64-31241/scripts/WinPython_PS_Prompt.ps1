...
if (-not ($env:WINPYDIR -eq [System.IO.Path]::GetFullPath( $env:WINPYDIRBASE+"\python-3.12.4.amd64")) ) {


$env:WINPYDIR = $env:WINPYDIRBASE+"\python-3.12.4.amd64"
